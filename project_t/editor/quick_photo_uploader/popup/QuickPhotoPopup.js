	...
	function html5Upload() {
	    ...
	    sUploadURL = 'http://localhost/editor/quick_photo_uploader/popup/FileUploader_html5.php'; //upload URL
	...
	function callFileUploader() {
	    oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"), {
	        sUrl: 'http://localhost/editor/quick_photo_uploader/popup/FileUploader.php', //샘플 URL입니다.
